...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitSqrtFunc(LabeledExprParser.SqrtFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCosFunc(LabeledExprParser.CosFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSinFunc(LabeledExprParser.SinFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTanFunc(LabeledExprParser.TanFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLnFunc(LabeledExprParser.LnFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogFunc(LabeledExprParser.LogFuncContext ctx);
}